[
  ...
  "role": "Back-end javascript developer focused on Node.js (server), Express.js (routing/api), express-handlebars (integrating handlebars with Express), express-session (adding session management to express), Passport.js (authentication), and the Stripe API (credit card processing).",
